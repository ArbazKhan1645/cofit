...
class RecipeDetailScreen extends GetView<RecipeController> {
        ...
        if (plan == null) {
          return SafeArea(
            child: Column(
              children: [
                _buildSimpleAppBar(context),
                Expanded(child: _buildDetailEmptyState(context)),
              ],
            ),
          );
        }
  ...
  Widget _buildDetailEmptyState(BuildContext context) {
    final isOffline = controller.detailOffline.value;
    return Center(
      child: Padding(
        padding: const EdgeInsets.all(32),
        child: Column(
          ...
          children: [
            Icon(
              isOffline ? Iconsax.wifi_square : Iconsax.note_remove,
              size: 64,
              color: AppColors.textMuted,
            ),
            const SizedBox(height: 16),
            Text(
              isOffline ? 'No Internet Connection' : 'Plan Not Found',
              style: Theme.of(context).textTheme.titleMedium?.copyWith(
                    fontWeight: FontWeight.w600,
            ...
            Text(
              isOffline
                  ...
                  : 'This plan may have been removed.',
