...
class AchievementFormScreen extends GetView<AchievementController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Obx(() => Text(controller.editingAchievement.value != null
            ? 'Edit Achievement'
            : 'Add Achievement')),
        actions: [
          Obx(() => TextButton(
                onPressed:
                    controller.isSaving.value ? null : controller.saveAchievement,
        ...
        child: Obx(() => Column(
              children: [
                Container(
                  ...
                  child: Icon(
                    IconData(controller.selectedIconCode.value,
      ...
      child: Obx(() => Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                value: controller.achievementType.value,
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                      value: 'streak_days', child: Text('Streak Days')),
                  DropdownMenuItem(
              ...
              DropdownButtonFormField<String>(
                value: controller.targetUnit.value,
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                      value: 'challenges', child: Text('Challenges')),
                ],
                onChanged: (v) {
              ...
              if (controller.achievementType.value == 'category_workouts') ...[
                const SizedBox(height: 16),
                DropdownButtonFormField<String>(
                  value: controller.targetCategory.value.isEmpty
                      ? null
                      : controller.targetCategory.value,
                  decoration:
                      const InputDecoration(labelText: 'Workout Category'),
                  items: const [
                    DropdownMenuItem(
      ...
      child: Obx(() => Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                decoration:
                    const InputDecoration(labelText: 'Achievement Category'),
                items: const [
                  DropdownMenuItem(
                  ...
                  DropdownMenuItem(
                      value: 'special', child: Text('Special')),
                ],
                onChanged: (v) {
